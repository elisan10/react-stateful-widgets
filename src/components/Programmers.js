...
export default function Programmers() {
  ...
  //      1              setterfunction
  const [programmers, setProgrammers] = React.useState(listOfAwesome);
  ...
  const getNameOfFeatured = () => {
    ...
    const selectedProgrammer = programmers.find((programmer) =>
      programmer.id === id ? programmer : "Programmer not found."
    );
    return selectedProgrammer.name;
  };
